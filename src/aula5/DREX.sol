...
//o codigo abaixo e para entendimento de como sera usado no DREX.
//Ainda nao a definicao por completa dos smart contracts mas o exemplo abaixo e uma leitura do ABI do repositorio do BACEN
...
contract RealDigital is ERC20, ERC20Burnable, AccessControl, Pausable {
    ...
    constructor(
        ...
        _mint(msg.sender, 100000000000000000000);//modificacao de mintagem para a conta que dployou o contrato
    }
